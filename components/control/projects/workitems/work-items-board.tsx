...
import {useUser} from '@/context/user-context'; // Import context để kiểm tra người dùng hiện tại
                                                        ...
                                                        <Draggable key={task._id} draggableId={task._id} index={index} isDragDisabled={!canChangeStatus}>
                                                            {(provided, snapshot) => (
                                                                <div
                                                                    ...
                                                                    className={cn(
                                                                        "group relative flex flex-col gap-3 p-4.5 rounded-[1.5rem] border",
                                                                    ...
                                                                    <div className="flex items-center gap-1 pt-1" onClick={stopProp}>
                                                                        <Popover modal={false}>
                                                                            <PopoverTrigger asChild disabled={!canChangeStatus}>
                                                                                <button className={cn(
                                                                                    "flex items-center justify-center gap-1 text-[9px] font-bold px-1 h-7 min-w-[70px] rounded-full border transition-all shadow-sm bg-white dark:bg-white/5 border-zinc-200/60 dark:border-white/5",
                                                                                    canChangeStatus && "hover:border-cyan-500/20"
                                                                                )}>
                                                                                    {(() => {
                                                                        ...
                                                                        <Popover modal={false}>
                                                                            <PopoverTrigger asChild disabled={!canManageWork}>
                                                                                <button className={cn(
